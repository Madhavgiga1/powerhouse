package com.example.powerhouseevaluation.Utils
...
/*sealed class that is used to handle the result of a network request in a more organized way. It has three sub-classes: Success, Error, and Loading.
